...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;500;600;700&family=Poppins&display=swap"
        rel="stylesheet">
        ...
        <div class="overlay">
            <div class="modal-content">
                <form>
                    ...
                    <input class="modal-input form-input" type="text" name="login" id="inputPassword" maxlength="15"
                        minlength="4" placeholder="Username" required>
                    <input class="modal-input form-input" type="password" name="password" id="inputPassword"
                        minlength="5" id="password" placeholder="Password" required>
        ...
        <div class="overlay">
            <div class="modal-content">
                <form>
                    ...
                    <input class="modal-input form-input" type="text" name="username" maxlength="15" minlength="4"
                        placeholder="Username" required>
                    <input class="modal-input form-input" type="text" name="username" maxlength="15" minlength="4"
                        placeholder="Email" required>
                    <input class="modal-input form-input" type="password" name="Пароль" minlength="6" id="password"
